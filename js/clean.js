...
alert("When you guess correctly, you will see your letter displayed below");
...
while (1 === 1) {       // !!! -= The game loop =- !!!
    ...
    console.log(" ");
    console.log("Your guesses so far in alphabetical order:");      // Logging information for the user
